...
contract LavevelICO is Ownable {
  ...
  uint256 public  RATE = 500; // Number of tokens per Ether
  uint256 public constant CAP = 10000; // Cap in Ether
  uint256 public constant START = 1519862400; // Mar 26, 2018 @ 12:00 EST
  uint256 public constant DAYS = 2000; 
  
  uint256 public constant initialTokens = 500000000000 * 10**9; // Initial number of tokens available
  ...
  function buyTokens() public payable  {
    require(msg.value >= 0.05 ether && msg.value <= 3 ether,'Amount range should be 0.05 to 3 BNB');
